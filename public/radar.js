...
import { Plane, createIconPopup, sortByAltitude } from "./plane-class.js";
// import { manageDropdownMenu } from './dropdown.js';
import { manageNavbar } from "./navbar.js";
import {
  createPlaneTypeElements,
  createAirlineElements,
  updateHeightText,
  switchCheckboxes,
  checkCheckboxState,
          ...
          function work() {
            fetchData(api)
              ...
              .then((res) => {
                ...
                const typeAirlineSwitch = document.getElementById(
                  "type-airline-input-switch"
                );
                const altitudeSwitch = document.getElementById(
                  "altitude-input-switch"
                );
              ...
              .then((res) => {
                createIconPopup(
                  ...
                  bannedTypes,
                  bannedAirlines,
                  isTypeAirlineFilterOn,
                  isAltitudeFilterOn
                ); //inside running functions for each obj (this running once)
                sortByAltitude(planesObjects);
              });
          }
